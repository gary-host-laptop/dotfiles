# Tokyo Night (dark) color_config for nushell.
# Values from nu_scripts themes (nushell/nu_scripts) -> themes/nu-themes/tokyo-night.nu.
# Only nushell's own UI colors are set (terminal palette is handled by ghostty/zellij).
